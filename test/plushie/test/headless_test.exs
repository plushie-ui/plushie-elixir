defmodule Plushie.Test.HeadlessTest do
  ...
  Enabled by setting PLUSHIE_HEADLESS=1 or PLUSHIE_TEST_BACKEND=headless.
  """
  ...
  # These tests are run via the standard test suite with PLUSHIE_TEST_BACKEND=headless.
