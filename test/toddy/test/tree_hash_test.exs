defmodule Toddy.Test.TreeHashTest do
  ...
  setup do
    tmp_dir =
      Path.join(System.tmp_dir!(), "toddy_tree_hash_test_#{System.unique_integer([:positive])}")
  ...
  describe "assert_match/2" do
    ...
    test "updates golden file when TODDY_UPDATE_SNAPSHOTS=1", %{golden_dir: dir} do
