defmodule Toddy.Test.CrossBackendTest do
  @moduledoc """
  Cross-backend equivalence tests.

  Defines shared assertions and runs them against the Pooled backend by
  default. To run against Headless, set TODDY_TEST_BACKEND=headless
  ...
  defp start_backend(app) do
    ...
    {:ok, pid} = backend.start(app, pool: Toddy.TestPool)
  ...
  defp resolve_backend do
    case System.get_env("TODDY_TEST_BACKEND") do
