defmodule Toddy.Iced.A11yTest do
  use ExUnit.Case, async: true

  alias Toddy.Iced.Widget.{Button, Column, Container, Slider, Text}
  alias Toddy.Tree
  ...
  describe "a11y prop on widget structs" do
    test "Button carries a11y prop through to_node" do
      ...
      node = Tree.normalize(Toddy.Iced.Widget.to_node(btn))
    ...
    test "Column carries a11y prop through to_node" do
      ...
      node = Tree.normalize(Toddy.Iced.Widget.to_node(col))
    ...
    test "Text with heading role and level" do
      ...
      node = Tree.normalize(Toddy.Iced.Widget.to_node(t))
  ...
  describe "encoding toggled/selected/value/orientation" do
    test "nil state fields are omitted from encoding" do
      a = %A11y{label: "test"}
      encoded = Toddy.Iced.Encode.encode(a)
