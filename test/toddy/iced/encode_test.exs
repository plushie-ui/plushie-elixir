defmodule Toddy.Iced.EncodeTest.BogusStruct do
  defstruct [:x]
end

defmodule Toddy.Iced.EncodeTest do
  use ExUnit.Case, async: true

  alias Toddy.Iced.Encode
  ...
  describe "Any (fallback)" do
    ...
    test "unknown structs raise with module name in message" do
      bogus = struct(Toddy.Iced.EncodeTest.BogusStruct, x: 1)
