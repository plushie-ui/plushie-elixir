defmodule Julep.ScopedIdTest do
  ...
  describe "Protocol.Decode scoped ID splitting" do
    test "simple ID has empty scope" do
      ...
      event = Julep.Protocol.Decode.decode_message(json, :json)
