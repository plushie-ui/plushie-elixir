defmodule JulepUIParityTestHelper do
  @moduledoc false
  import Julep.UI
...
defmodule Julep.UIParityTest do
  @moduledoc """
  Tests for all new widgets in Julep.UI added in the iced parity pass.
  Does not duplicate tests from ui_test.exs.
  """
  use ExUnit.Case, async: true

  alias JulepUIParityTestHelper, as: H
