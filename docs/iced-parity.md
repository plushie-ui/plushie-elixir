...
| `Simulator::snapshot()` | `snapshot("name")` via snapshot_capture protocol |
...
| Pixel snapshots | Headless: SHA-256 of serialized tree JSON (structural). Full: real GPU-rendered RGBA via wgpu. |
