defmodule Julep.Protocol do
  ...
  * `Julep.Protocol.Encode` -- all `encode_*` functions and serialization
  * `Julep.Protocol.Decode` -- `decode/2`, `decode_message/2`, and dispatch
  * `Julep.Protocol.Keys` -- named/physical key maps and `parse_key/1`
  * `Julep.Protocol.Parsers` -- shared string-to-atom parsers
  """
  ...
  defdelegate encode(map, format \\ :msgpack), to: Julep.Protocol.Encode
  ...
  ## Example
      ...
      Julep.Protocol.encode_settings(%{antialiasing: true, default_text_size: 16}, :json)
  ...
  defdelegate encode_settings(settings, format \\ :msgpack), to: Julep.Protocol.Encode
  ...
  ## Example
      ...
      Julep.Protocol.encode_snapshot(%{tag: "text", value: "hello"}, :json)
      #=> ~s({"session":"","tree":{"tag":"text","value":"hello"},"type":"snapshot"}) <> "\\n"
  """
  @spec encode_snapshot(tree :: term(), format :: format()) :: binary()
  defdelegate encode_snapshot(tree, format \\ :msgpack), to: Julep.Protocol.Encode
  ...
  ## Example
      ...
      Julep.Protocol.encode_patch([], :json)
      #=> ~s({"ops":[],"session":"","type":"patch"}) <> "\\n"
  """
  @spec encode_patch(ops :: list(), format :: format()) :: binary()
  defdelegate encode_patch(ops, format \\ :msgpack), to: Julep.Protocol.Encode
  ...
  ## Example
      ...
      Julep.Protocol.encode_effect("req_1", "file_open", %{title: "Pick a file"}, :json)
  ...
  defdelegate encode_effect(id, kind, payload, format \\ :msgpack), to: Julep.Protocol.Encode
  ...
  ## Example
      ...
      Julep.Protocol.encode_widget_op("focus", %{target: "username"}, :json)
  ...
  defdelegate encode_widget_op(op, payload, format \\ :msgpack), to: Julep.Protocol.Encode
  ...
  ## Example
      ...
      Julep.Protocol.encode_subscribe("on_key_press", "keys", :json)
      #=> ~s({"kind":"on_key_press","session":"","tag":"keys","type":"subscribe"}) <> "\\n"
  """
  @spec encode_subscribe(kind :: String.t(), tag :: String.t(), format :: format()) ::
          binary()
  defdelegate encode_subscribe(kind, tag, format \\ :msgpack), to: Julep.Protocol.Encode
  ...
  ## Example
      ...
      Julep.Protocol.encode_unsubscribe("on_key_press", :json)
      #=> ~s({"kind":"on_key_press","session":"","type":"unsubscribe"}) <> "\\n"
  """
  @spec encode_unsubscribe(kind :: String.t(), format :: format()) :: binary()
  defdelegate encode_unsubscribe(kind, format \\ :msgpack), to: Julep.Protocol.Encode
  ...
  ## Example
      ...
      Julep.Protocol.encode_image_op("create_image", %{handle: "logo", data: <<1, 2, 3>>}, :json)
  ...
  defdelegate encode_image_op(op, payload, format \\ :msgpack), to: Julep.Protocol.Encode
  ...
  defdelegate encode_extension_commands(commands, format \\ :msgpack), to: Julep.Protocol.Encode
  ...
  ## Example
      ...
      Julep.Protocol.encode_window_op("open", "main", %{title: "My App"}, :json)
  ...
  defdelegate encode_advance_frame(timestamp, format \\ :msgpack), to: Julep.Protocol.Encode
  ...
  defdelegate decode(data, format \\ :msgpack), to: Julep.Protocol.Decode
  ...
  defdelegate decode_message(data, format \\ :msgpack), to: Julep.Protocol.Decode
  ...
  defdelegate parse_key(key), to: Julep.Protocol.Keys
end
