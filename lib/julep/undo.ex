defmodule Julep.Undo do
  ...
  ## Example
      ...
      iex> u = Julep.Undo.new(0)
      iex> cmd = %{apply: &(&1 + 1), undo: &(&1 - 1)}
      iex> u = Julep.Undo.apply(u, cmd)
      iex> Julep.Undo.current(u)
      1
      iex> u = Julep.Undo.undo(u)
      iex> Julep.Undo.current(u)
      0
  """
  ...
  defp timestamp do
    case Process.get(:julep_undo_timestamp) do
