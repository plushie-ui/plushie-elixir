defmodule Julep.Iced.Widget.TextEditor do
  ...
  @spec with_options(editor :: t(), opts :: [option()]) :: t()
  ...
  @spec build(editor :: t()) :: Julep.Iced.ui_node()
