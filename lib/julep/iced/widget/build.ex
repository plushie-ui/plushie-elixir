defmodule Julep.Iced.Widget.Build do
  ...
  @spec to_node(child :: map() | struct()) :: Julep.Iced.ui_node()
  def to_node(%{id: _, type: _, props: _, children: _} = node), do: node
  def to_node(%_module{} = widget), do: Julep.Iced.Widget.to_node(widget)

  @doc "Converts a list of children (maps or structs) to ui_node() maps."
  @spec children_to_nodes(children :: [map() | struct()]) :: [Julep.Iced.ui_node()]
