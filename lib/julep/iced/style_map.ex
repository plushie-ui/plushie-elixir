defmodule Julep.Iced.StyleMap do
  @moduledoc """
  ...
  ## Example
      ...
      style = Julep.Iced.StyleMap.new()
              |> Julep.Iced.StyleMap.background("#3366ff")
              |> Julep.Iced.StyleMap.text_color(:white)
  ...
  @spec border(style_map :: t(), border :: Julep.Iced.Border.t()) :: t()
  def border(%__MODULE__{} = style_map, border) do
    %{style_map | border: border}
  end

  @doc "Sets the shadow specification."
  @spec shadow(style_map :: t(), shadow :: Julep.Iced.Shadow.t()) :: t()
