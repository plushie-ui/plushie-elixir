defmodule Toddy.Event do
  ...
  ## Examples
      ...
      iex> Toddy.Event.target(%Toddy.Event.Widget{type: :click, id: "save", scope: []})
      "save"

      iex> Toddy.Event.target(%Toddy.Event.Widget{type: :click, id: "save", scope: ["form", "sidebar"]})
      "sidebar/form/save"
  """
