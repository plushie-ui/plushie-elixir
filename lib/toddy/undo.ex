defmodule Toddy.Undo do
  ...
  ## Example
      ...
      iex> u = Toddy.Undo.new(0)
      iex> cmd = %{apply: &(&1 + 1), undo: &(&1 - 1)}
      iex> u = Toddy.Undo.apply(u, cmd)
      iex> Toddy.Undo.current(u)
      1
      iex> u = Toddy.Undo.undo(u)
      iex> Toddy.Undo.current(u)
      0
  """
  ...
  defp timestamp do
    case Process.get(:toddy_undo_timestamp) do
