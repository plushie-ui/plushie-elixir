defmodule Toddy.Iced.StyleMap do
  @moduledoc """
...
defimpl Toddy.Iced.Encode, for: Toddy.Iced.StyleMap do
  ...
  defp put_field(map, key, value), do: Map.put(map, key, Toddy.Iced.Encode.encode(value))
