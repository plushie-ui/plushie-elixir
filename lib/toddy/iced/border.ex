defmodule Toddy.Iced.Border do
  @moduledoc """
  ...
  def color(%__MODULE__{} = border, color), do: %{border | color: Toddy.Iced.Color.cast(color)}
...
defimpl Toddy.Iced.Encode, for: Toddy.Iced.Border do
  def encode(%Toddy.Iced.Border{} = border) do
    Toddy.Iced.Border.encode(border)
  end
end
