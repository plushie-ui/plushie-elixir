defmodule Toddy.Iced.Widget.Markdown do
  @moduledoc """
  ...
  @doc "Converts this markdown struct to a `ui_node()` map via the `Toddy.Iced.Widget` protocol."
  @spec build(markdown :: t()) :: Toddy.Iced.ui_node()
  def build(%__MODULE__{} = md), do: Toddy.Iced.Widget.to_node(md)
