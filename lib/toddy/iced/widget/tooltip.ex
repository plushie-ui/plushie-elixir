defmodule Toddy.Iced.Widget.Tooltip do
  @moduledoc """
  ...
  alias Toddy.Iced.Widget.{Build, Container}
  ...
  @doc "Converts this tooltip struct to a `ui_node()` map via the `Toddy.Iced.Widget` protocol."
  @spec build(tooltip :: t()) :: Toddy.Iced.ui_node()
  def build(%__MODULE__{} = tt), do: Toddy.Iced.Widget.to_node(tt)
