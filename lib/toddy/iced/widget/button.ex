defmodule Toddy.Iced.Widget.Button do
  @moduledoc """
  ...
  @doc "Converts this button struct to a `ui_node()` map via the `Toddy.Iced.Widget` protocol."
  @spec build(button :: t()) :: Toddy.Iced.ui_node()
  def build(%__MODULE__{} = btn), do: Toddy.Iced.Widget.to_node(btn)
