defmodule Toddy.Iced.Widget.Overlay do
  @moduledoc """
  ...
  @doc "Converts this overlay struct to a `ui_node()` map via the `Toddy.Iced.Widget` protocol."
  @spec build(overlay :: t()) :: Toddy.Iced.ui_node()
  def build(%__MODULE__{} = overlay), do: Toddy.Iced.Widget.to_node(overlay)
