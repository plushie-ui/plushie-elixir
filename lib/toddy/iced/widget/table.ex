defmodule Toddy.Iced.Widget.Table do
  @moduledoc """
  ...
  @doc "Converts this table struct to a `ui_node()` map via the `Toddy.Iced.Widget` protocol."
  @spec build(table :: t()) :: Toddy.Iced.ui_node()
  def build(%__MODULE__{} = tbl), do: Toddy.Iced.Widget.to_node(tbl)
