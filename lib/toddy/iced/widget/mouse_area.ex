defmodule Toddy.Iced.Widget.MouseArea do
  @moduledoc """
  ...
  @doc "Converts this mouse area struct to a `ui_node()` map via the `Toddy.Iced.Widget` protocol."
  @spec build(mouse_area :: t()) :: Toddy.Iced.ui_node()
  def build(%__MODULE__{} = ma), do: Toddy.Iced.Widget.to_node(ma)
