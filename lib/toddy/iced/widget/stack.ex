defmodule Toddy.Iced.Widget.Stack do
  @moduledoc """
  ...
  @doc "Converts this stack struct to a `ui_node()` map via the `Toddy.Iced.Widget` protocol."
  @spec build(stack :: t()) :: Toddy.Iced.ui_node()
  def build(%__MODULE__{} = stack), do: Toddy.Iced.Widget.to_node(stack)
