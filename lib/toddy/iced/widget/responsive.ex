defmodule Toddy.Iced.Widget.Responsive do
  @moduledoc """
  ...
  @doc "Converts this responsive struct to a `ui_node()` map via the `Toddy.Iced.Widget` protocol."
  @spec build(responsive :: t()) :: Toddy.Iced.ui_node()
  def build(%__MODULE__{} = r), do: Toddy.Iced.Widget.to_node(r)
