defmodule Toddy.Iced.Widget.TextInput do
  @moduledoc """
  ...
  @doc "Converts this text input struct to a `ui_node()` map via the `Toddy.Iced.Widget` protocol."
  @spec build(text_input :: t()) :: Toddy.Iced.ui_node()
  def build(%__MODULE__{} = ti), do: Toddy.Iced.Widget.to_node(ti)
