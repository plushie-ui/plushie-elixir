defmodule Toddy.Iced.Widget.Column do
  @moduledoc """
  ...
  - `padding` (number | map) -- padding inside the column. Accepts a uniform number
    or `%{top, right, bottom, left}` map. See `Toddy.Iced.Padding`.
  - `width` (length) -- width of the column. Default: shrink. See `Toddy.Iced.Length`.
  - `height` (length) -- height of the column. Default: shrink.
  - `max_width` (number) -- maximum width in pixels.
  - `align_x` -- horizontal alignment of children: `:start`, `:center`, `:end`. See `Toddy.Iced.Alignment`.
  ...
  @spec align_x(column :: t(), align_x :: Toddy.Iced.Alignment.t()) :: t()
  ...
  @spec push(column :: t(), child :: Toddy.Iced.ui_node() | struct()) :: t()
  def push(%__MODULE__{} = col, child), do: %{col | children: [child | col.children]}

  @doc "Appends multiple children to the column."
  @spec extend(column :: t(), children :: [Toddy.Iced.ui_node() | struct()]) :: t()
  def extend(%__MODULE__{} = col, children),
    do: %{col | children: Enum.reverse(children) ++ col.children}

  @doc "Sets accessibility annotations."
  @spec a11y(column :: t(), a11y :: Toddy.Iced.A11y.t()) :: t()
  def a11y(%__MODULE__{} = col, a11y), do: %{col | a11y: A11y.cast(a11y)}

  @doc "Converts this column struct to a `ui_node()` map via the `Toddy.Iced.Widget` protocol."
  @spec build(column :: t()) :: Toddy.Iced.ui_node()
  def build(%__MODULE__{} = col), do: Toddy.Iced.Widget.to_node(col)
