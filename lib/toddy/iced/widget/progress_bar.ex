defmodule Toddy.Iced.Widget.ProgressBar do
  @moduledoc """
  ...
  @doc "Converts this progress bar struct to a `ui_node()` map via the `Toddy.Iced.Widget` protocol."
  @spec build(progress_bar :: t()) :: Toddy.Iced.ui_node()
  def build(%__MODULE__{} = bar), do: Toddy.Iced.Widget.to_node(bar)
