defmodule Toddy.Iced.Widget.Themer do
  @moduledoc """
  ...
  @doc "Converts this themer struct to a `ui_node()` map via the `Toddy.Iced.Widget` protocol."
  @spec build(themer :: t()) :: Toddy.Iced.ui_node()
  def build(%__MODULE__{} = t), do: Toddy.Iced.Widget.to_node(t)
