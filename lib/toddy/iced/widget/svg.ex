defmodule Toddy.Iced.Widget.Svg do
  @moduledoc """
  ...
  @doc "Converts this SVG struct to a `ui_node()` map via the `Toddy.Iced.Widget` protocol."
  @spec build(svg :: t()) :: Toddy.Iced.ui_node()
  def build(%__MODULE__{} = svg), do: Toddy.Iced.Widget.to_node(svg)
