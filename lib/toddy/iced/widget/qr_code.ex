defmodule Toddy.Iced.Widget.QrCode do
  @moduledoc """
  ...
  @doc "Converts this QR code struct to a `ui_node()` map via the `Toddy.Iced.Widget` protocol."
  @spec build(qr_code :: t()) :: Toddy.Iced.ui_node()
  def build(%__MODULE__{} = qr), do: Toddy.Iced.Widget.to_node(qr)
