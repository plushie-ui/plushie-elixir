defmodule Toddy.Iced.Widget.KeyedColumn do
  @moduledoc """
  ...
  - `padding` (number | map) -- padding inside the column. See `Toddy.Iced.Padding`.
  - `width` (length) -- column width. Default: shrink. See `Toddy.Iced.Length`.
  ...
  @doc "Converts this keyed column struct to a `ui_node()` map via the `Toddy.Iced.Widget` protocol."
  @spec build(keyed_column :: t()) :: Toddy.Iced.ui_node()
  def build(%__MODULE__{} = kc), do: Toddy.Iced.Widget.to_node(kc)
