defmodule Toddy.Iced.Widget.Grid do
  @moduledoc """
  ...
  @doc "Converts this grid struct to a `ui_node()` map via the `Toddy.Iced.Widget` protocol."
  @spec build(grid :: t()) :: Toddy.Iced.ui_node()
  def build(%__MODULE__{} = grid), do: Toddy.Iced.Widget.to_node(grid)
