defmodule Toddy.Iced.Widget.PickList do
  @moduledoc """
  ...
  @doc "Converts this pick list struct to a `ui_node()` map via the `Toddy.Iced.Widget` protocol."
  @spec build(pick_list :: t()) :: Toddy.Iced.ui_node()
  def build(%__MODULE__{} = pl), do: Toddy.Iced.Widget.to_node(pl)
