defmodule Toddy.Iced.Widget.TextEditor do
  @moduledoc """
  ...
  @doc "Converts this text editor struct to a `ui_node()` map via the `Toddy.Iced.Widget` protocol."
  @spec build(text_editor :: t()) :: Toddy.Iced.ui_node()
  def build(%__MODULE__{} = ed), do: Toddy.Iced.Widget.to_node(ed)
