defmodule Toddy.Iced.Gradient do
  @moduledoc """
  ...
  ## Example
      ...
      gradient = Toddy.Iced.Gradient.linear(90, [
        {0.0, "#ff0000"},
        {0.5, "#00ff00"},
        {1.0, "#0000ff"}
      ])
  ...
  @type stop_color :: Toddy.Iced.Color.input() | %{r: float(), g: float(), b: float(), a: float()}
  ...
  defp cast_stop_color(color), do: Toddy.Iced.Color.cast(color)
