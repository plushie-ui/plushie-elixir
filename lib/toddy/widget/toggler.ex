defmodule Toddy.Widget.Toggler do
  @moduledoc """
  ...
  @spec width(toggler :: t(), width :: Toddy.Type.Length.t()) :: t()
  ...
  @spec font(toggler :: t(), font :: Toddy.Type.Font.t()) :: t()
  ...
  @spec text_alignment(toggler :: t(), text_alignment :: Toddy.Type.Alignment.t()) :: t()
  ...
  @spec a11y(toggler :: t(), a11y :: Toddy.Type.A11y.t()) :: t()
  def a11y(%__MODULE__{} = tg, a11y), do: %{tg | a11y: A11y.cast(a11y)}

  @doc "Converts this toggler struct to a `ui_node()` map via the `Toddy.Widget` protocol."
  @spec build(toggler :: t()) :: Toddy.Widget.ui_node()
  def build(%__MODULE__{} = tg), do: Toddy.Widget.to_node(tg)
