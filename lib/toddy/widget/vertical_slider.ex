defmodule Toddy.Widget.VerticalSlider do
  @moduledoc """
  ...
  - `height` (length) -- slider height. Default: fill. See `Toddy.Type.Length`.
  ...
  @spec width(vertical_slider :: t(), width :: Toddy.Type.Length.t()) :: t()
  def width(%__MODULE__{} = slider, width), do: %{slider | width: width}

  @doc "Sets the slider height."
  @spec height(vertical_slider :: t(), height :: Toddy.Type.Length.t()) :: t()
  def height(%__MODULE__{} = slider, height), do: %{slider | height: height}

  @doc "Sets the rail color."
  @spec rail_color(vertical_slider :: t(), rail_color :: Toddy.Type.Color.input()) :: t()
  ...
  @doc "Converts this vertical slider struct to a `ui_node()` map via the `Toddy.Widget` protocol."
  @spec build(vertical_slider :: t()) :: Toddy.Widget.ui_node()
