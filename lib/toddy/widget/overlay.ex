defmodule Toddy.Widget.Overlay do
  @moduledoc """
  ...
  @spec push(overlay :: t(), child :: Toddy.Widget.ui_node() | struct()) :: t()
  def push(%__MODULE__{} = overlay, child), do: %{overlay | children: [child | overlay.children]}

  @doc "Appends multiple children to the overlay."
  @spec extend(overlay :: t(), children :: [Toddy.Widget.ui_node() | struct()]) :: t()
  def extend(%__MODULE__{} = overlay, children),
    do: %{overlay | children: Enum.reverse(children) ++ overlay.children}

  @doc "Sets accessibility annotations."
  @spec a11y(overlay :: t(), a11y :: Toddy.Type.A11y.t()) :: t()
  def a11y(%__MODULE__{} = overlay, a11y), do: %{overlay | a11y: A11y.cast(a11y)}

  @doc "Converts this overlay struct to a `ui_node()` map via the `Toddy.Widget` protocol."
  @spec build(overlay :: t()) :: Toddy.Widget.ui_node()
  def build(%__MODULE__{} = overlay), do: Toddy.Widget.to_node(overlay)
