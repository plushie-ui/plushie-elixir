defmodule Toddy.Widget.TextEditor do
  @moduledoc """
  ...
  @doc "Sets the font."
  @spec font(text_editor :: t(), font :: Toddy.Type.Font.t()) :: t()
  ...
  @spec wrapping(text_editor :: t(), wrapping :: Toddy.Type.Wrapping.t()) :: t()
  ...
  @spec placeholder_color(text_editor :: t(), color :: Toddy.Type.Color.input()) :: t()
  ...
  @spec selection_color(text_editor :: t(), color :: Toddy.Type.Color.input()) :: t()
  def selection_color(%__MODULE__{} = ed, color),
    do: %{ed | selection_color: Color.cast(color)}

  @doc "Sets accessibility annotations."
  @spec a11y(text_editor :: t(), a11y :: Toddy.Type.A11y.t()) :: t()
  def a11y(%__MODULE__{} = ed, a11y), do: %{ed | a11y: A11y.cast(a11y)}

  @doc "Converts this text editor struct to a `ui_node()` map via the `Toddy.Widget` protocol."
  @spec build(text_editor :: t()) :: Toddy.Widget.ui_node()
  def build(%__MODULE__{} = ed), do: Toddy.Widget.to_node(ed)
