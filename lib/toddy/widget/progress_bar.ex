defmodule Toddy.Widget.ProgressBar do
  @moduledoc """
  ...
  - `width` (length) -- bar width. Default: fill. See `Toddy.Type.Length`.
  ...
  @spec width(progress_bar :: t(), width :: Toddy.Type.Length.t()) :: t()
  def width(%__MODULE__{} = bar, width), do: %{bar | width: width}

  @doc "Sets the progress bar height."
  @spec height(progress_bar :: t(), height :: Toddy.Type.Length.t()) :: t()
  ...
  @doc "Converts this progress bar struct to a `ui_node()` map via the `Toddy.Widget` protocol."
  @spec build(progress_bar :: t()) :: Toddy.Widget.ui_node()
  def build(%__MODULE__{} = bar), do: Toddy.Widget.to_node(bar)
