defmodule Toddy.Widget.Sensor do
  @moduledoc """
  ...
  @spec extend(sensor :: t(), children :: [Toddy.Widget.ui_node() | struct()]) :: t()
  ...
  @spec a11y(sensor :: t(), a11y :: Toddy.Type.A11y.t()) :: t()
  def a11y(%__MODULE__{} = sensor, a11y), do: %{sensor | a11y: A11y.cast(a11y)}

  @doc "Converts this sensor struct to a `ui_node()` map via the `Toddy.Widget` protocol."
  @spec build(sensor :: t()) :: Toddy.Widget.ui_node()
  def build(%__MODULE__{} = sensor), do: Toddy.Widget.to_node(sensor)
