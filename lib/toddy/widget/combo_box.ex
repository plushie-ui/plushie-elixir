defmodule Toddy.Widget.ComboBox do
  @moduledoc """
  ...
  - `icon` (map) -- display an icon inside the text input. Same format as
    `Toddy.Widget.TextInput` icon prop.
  ...
  @spec width(combo_box :: t(), width :: Toddy.Type.Length.t()) :: t()
  def width(%__MODULE__{} = cb, width), do: %{cb | width: width}

  @doc "Sets the internal padding."
  @spec padding(combo_box :: t(), padding :: Toddy.Type.Padding.t()) :: t()
  ...
  @doc "Sets the font."
  @spec font(combo_box :: t(), font :: Toddy.Type.Font.t()) :: t()
  ...
  @spec shaping(combo_box :: t(), shaping :: Toddy.Type.Shaping.t()) :: t()
  ...
  @spec a11y(combo_box :: t(), a11y :: Toddy.Type.A11y.t()) :: t()
  def a11y(%__MODULE__{} = cb, a11y), do: %{cb | a11y: A11y.cast(a11y)}

  @doc "Converts this combo box struct to a `ui_node()` map via the `Toddy.Widget` protocol."
  @spec build(combo_box :: t()) :: Toddy.Widget.ui_node()
  def build(%__MODULE__{} = cb), do: Toddy.Widget.to_node(cb)
