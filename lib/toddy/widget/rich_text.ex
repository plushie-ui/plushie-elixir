defmodule Toddy.Widget.RichText do
  @moduledoc """
  ...
  - `spans` (list of maps) -- list of span descriptors. Each span is a map with:
    ...
    - `highlight` (map) -- visual highlight behind the span text. Accepts:
      - `background` (color) -- background color. See `Toddy.Type.Color`.
      - `border` (map) -- border around the highlight. Accepts `color` (color),
        `width` (number), and `radius` (number or list of 4 numbers).
  - `width` (length) -- widget width. Default: shrink. See `Toddy.Type.Length`.
  ...
  @spec width(rich_text :: t(), width :: Toddy.Type.Length.t()) :: t()
  def width(%__MODULE__{} = rt, width), do: %{rt | width: width}

  @doc "Sets the widget height."
  @spec height(rich_text :: t(), height :: Toddy.Type.Length.t()) :: t()
  ...
  @spec font(rich_text :: t(), font :: Toddy.Type.Font.t()) :: t()
  def font(%__MODULE__{} = rt, font), do: %{rt | font: font}

  @doc "Sets the default text color for all spans."
  @spec color(rich_text :: t(), color :: Toddy.Type.Color.input()) :: t()
  def color(%__MODULE__{} = rt, color), do: %{rt | color: Toddy.Type.Color.cast(color)}
  ...
  @spec wrapping(rich_text :: t(), wrapping :: Toddy.Type.Wrapping.t()) :: t()
  ...
  @spec a11y(rich_text :: t(), a11y :: Toddy.Type.A11y.t()) :: t()
  def a11y(%__MODULE__{} = rt, a11y), do: %{rt | a11y: A11y.cast(a11y)}

  @doc "Converts this rich text struct to a `ui_node()` map via the `Toddy.Widget` protocol."
  @spec build(rich_text :: t()) :: Toddy.Widget.ui_node()
  def build(%__MODULE__{} = rt), do: Toddy.Widget.to_node(rt)
