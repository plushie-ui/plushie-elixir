defmodule Toddy.Widget.Svg do
  ...
  - `width` (length) -- SVG width. Default: shrink. See `Toddy.Type.Length`.
  - `height` (length) -- SVG height. Default: shrink.
  - `content_fit` -- how the SVG fits its bounds. See `Toddy.Type.ContentFit`.
  ...
  @spec color(svg :: t(), color :: Toddy.Type.Color.input()) :: t()
  ...
  @doc "Converts this SVG struct to a `ui_node()` map via the `Toddy.Widget` protocol."
  @spec build(svg :: t()) :: Toddy.Widget.ui_node()
  def build(%__MODULE__{} = svg), do: Toddy.Widget.to_node(svg)
