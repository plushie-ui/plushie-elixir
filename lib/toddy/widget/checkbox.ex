defmodule Toddy.Widget.Checkbox do
  @moduledoc """
  ...
  @spec width(checkbox :: t(), width :: Toddy.Type.Length.t()) :: t()
  ...
  @spec font(checkbox :: t(), font :: Toddy.Type.Font.t()) :: t()
  ...
  @spec a11y(checkbox :: t(), a11y :: Toddy.Type.A11y.t()) :: t()
  def a11y(%__MODULE__{} = cb, a11y), do: %{cb | a11y: A11y.cast(a11y)}

  @doc "Converts this checkbox struct to a `ui_node()` map via the `Toddy.Widget` protocol."
  @spec build(checkbox :: t()) :: Toddy.Widget.ui_node()
