defmodule Toddy.Widget.Column do
  @moduledoc """
  ...
  - `padding` (number | map) -- padding inside the column. Accepts a uniform number
    or `%{top, right, bottom, left}` map. See `Toddy.Type.Padding`.
  - `width` (length) -- width of the column. Default: shrink. See `Toddy.Type.Length`.
  - `height` (length) -- height of the column. Default: shrink.
  - `max_width` (number) -- maximum width in pixels.
  - `align_x` -- horizontal alignment of children: `:start`, `:center`, `:end`. See `Toddy.Type.Alignment`.
  ...
  @spec align_x(column :: t(), align_x :: Toddy.Type.Alignment.t()) :: t()
  ...
  @spec push(column :: t(), child :: Toddy.Widget.ui_node() | struct()) :: t()
  def push(%__MODULE__{} = col, child), do: %{col | children: [child | col.children]}

  @doc "Appends multiple children to the column."
  @spec extend(column :: t(), children :: [Toddy.Widget.ui_node() | struct()]) :: t()
  def extend(%__MODULE__{} = col, children),
    do: %{col | children: Enum.reverse(children) ++ col.children}

  @doc "Sets accessibility annotations."
  @spec a11y(column :: t(), a11y :: Toddy.Type.A11y.t()) :: t()
  def a11y(%__MODULE__{} = col, a11y), do: %{col | a11y: A11y.cast(a11y)}

  @doc "Converts this column struct to a `ui_node()` map via the `Toddy.Widget` protocol."
  @spec build(column :: t()) :: Toddy.Widget.ui_node()
  def build(%__MODULE__{} = col), do: Toddy.Widget.to_node(col)
