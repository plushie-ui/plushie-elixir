defmodule Toddy.Widget.Image do
  @moduledoc """
  ...
  - `width` (length) -- image width. Default: shrink. See `Toddy.Type.Length`.
  - `height` (length) -- image height. Default: shrink.
  - `content_fit` -- how the image fits its bounds. See `Toddy.Type.ContentFit`.
  - `rotation` (number) -- rotation angle in degrees.
  - `opacity` (number) -- opacity from 0.0 (transparent) to 1.0 (opaque).
  - `border_radius` (number) -- corner radius in pixels.
  - `filter_method` -- image interpolation mode. See `Toddy.Type.FilterMethod`.
  ...
  @type option ::
          ...
          | {:content_fit, Toddy.Type.ContentFit.t()}
          | {:rotation, number()}
          | {:opacity, number()}
          | {:border_radius, number()}
          | {:filter_method, Toddy.Type.FilterMethod.t()}
          | {:expand, boolean()}
          | {:scale, number()}
          | {:crop, map()}
          | {:alt, String.t()}
  ...
  @type t :: %__MODULE__{
          ...
          content_fit: Toddy.Type.ContentFit.t() | nil,
          rotation: number() | nil,
          opacity: number() | nil,
          border_radius: number() | nil,
          filter_method: Toddy.Type.FilterMethod.t() | nil,
          expand: boolean() | nil,
          scale: number() | nil,
          crop: map() | nil,
          alt: String.t() | nil,
  ...
  @spec filter_method(image :: t(), filter_method :: Toddy.Type.FilterMethod.t()) :: t()
  ...
  @doc "Converts this image struct to a `ui_node()` map via the `Toddy.Widget` protocol."
  @spec build(image :: t()) :: Toddy.Widget.ui_node()
  def build(%__MODULE__{} = img), do: Toddy.Widget.to_node(img)
