defmodule Toddy.Widget.TextInput do
  @moduledoc """
  ...
  - `width` (length) -- input width. Default: fill. See `Toddy.Type.Length`.
  ...
  - `placeholder_color` (color) -- placeholder text color. See `Toddy.Type.Color`.
  - `selection_color` (color) -- text selection highlight color. See `Toddy.Type.Color`.
  ...
  @type option ::
          ...
          | {:style, style()}
          | {:placeholder_color, Toddy.Type.Color.input()}
          | {:selection_color, Toddy.Type.Color.input()}
  ...
  @type t :: %__MODULE__{
          ...
          style: style() | nil,
          placeholder_color: Toddy.Type.Color.t() | nil,
          selection_color: Toddy.Type.Color.t() | nil,
  ...
  @spec padding(text_input :: t(), padding :: Toddy.Type.Padding.t()) :: t()
  def padding(%__MODULE__{} = ti, padding), do: %{ti | padding: padding}

  @doc "Sets the input width."
  @spec width(text_input :: t(), width :: Toddy.Type.Length.t()) :: t()
  ...
  @doc "Sets the font."
  @spec font(text_input :: t(), font :: Toddy.Type.Font.t()) :: t()
  ...
  @spec align_x(text_input :: t(), align_x :: Toddy.Type.Alignment.t()) :: t()
  ...
  @spec placeholder_color(text_input :: t(), color :: Toddy.Type.Color.input()) :: t()
  ...
  @spec selection_color(text_input :: t(), color :: Toddy.Type.Color.input()) :: t()
  def selection_color(%__MODULE__{} = ti, color),
    do: %{ti | selection_color: Color.cast(color)}

  @doc "Sets accessibility annotations."
  @spec a11y(text_input :: t(), a11y :: Toddy.Type.A11y.t()) :: t()
  def a11y(%__MODULE__{} = ti, a11y), do: %{ti | a11y: A11y.cast(a11y)}

  @doc "Converts this text input struct to a `ui_node()` map via the `Toddy.Widget` protocol."
  @spec build(text_input :: t()) :: Toddy.Widget.ui_node()
  def build(%__MODULE__{} = ti), do: Toddy.Widget.to_node(ti)
