defmodule Toddy.Widget.MouseArea do
  @moduledoc """
  ...
  @spec push(mouse_area :: t(), child :: Toddy.Widget.ui_node() | struct()) :: t()
  def push(%__MODULE__{} = ma, child), do: %{ma | children: [child | ma.children]}

  @doc "Appends multiple children to the mouse area."
  @spec extend(mouse_area :: t(), children :: [Toddy.Widget.ui_node() | struct()]) :: t()
  ...
  @doc "Converts this mouse area struct to a `ui_node()` map via the `Toddy.Widget` protocol."
  @spec build(mouse_area :: t()) :: Toddy.Widget.ui_node()
  def build(%__MODULE__{} = ma), do: Toddy.Widget.to_node(ma)
