defmodule Toddy.Widget.PickList do
  @moduledoc """
  ...
  @spec width(pick_list :: t(), width :: Toddy.Type.Length.t()) :: t()
  def width(%__MODULE__{} = pl, width), do: %{pl | width: width}

  @doc "Sets the internal padding."
  @spec padding(pick_list :: t(), padding :: Toddy.Type.Padding.t()) :: t()
  ...
  @doc "Sets the font."
  @spec font(pick_list :: t(), font :: Toddy.Type.Font.t()) :: t()
  ...
  @spec a11y(pick_list :: t(), a11y :: Toddy.Type.A11y.t()) :: t()
  def a11y(%__MODULE__{} = pl, a11y), do: %{pl | a11y: A11y.cast(a11y)}

  @doc "Converts this pick list struct to a `ui_node()` map via the `Toddy.Widget` protocol."
  @spec build(pick_list :: t()) :: Toddy.Widget.ui_node()
  def build(%__MODULE__{} = pl), do: Toddy.Widget.to_node(pl)
