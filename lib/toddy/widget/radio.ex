defmodule Toddy.Widget.Radio do
  @moduledoc """
  ...
  @spec width(radio :: t(), width :: Toddy.Type.Length.t()) :: t()
  ...
  @spec font(radio :: t(), font :: Toddy.Type.Font.t()) :: t()
  ...
  @spec a11y(radio :: t(), a11y :: Toddy.Type.A11y.t()) :: t()
  def a11y(%__MODULE__{} = r, a11y), do: %{r | a11y: A11y.cast(a11y)}

  @doc "Converts this radio struct to a `ui_node()` map via the `Toddy.Widget` protocol."
  @spec build(radio :: t()) :: Toddy.Widget.ui_node()
