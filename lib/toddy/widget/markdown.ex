defmodule Toddy.Widget.Markdown do
  @moduledoc """
  ...
  - `width` (length) -- container width. See `Toddy.Type.Length`.
  ...
  @type option ::
          ...
          | {:code_size, number()}
          | {:spacing, number()}
          | {:link_color, Toddy.Type.Color.input()}
          | {:code_theme, String.t()}
  ...
  @type t :: %__MODULE__{
          ...
          spacing: number() | nil,
          link_color: Toddy.Type.Color.t() | nil,
  ...
  @spec width(markdown :: t(), width :: Toddy.Type.Length.t()) :: t()
  ...
  @spec link_color(markdown :: t(), link_color :: Toddy.Type.Color.input()) :: t()
  ...
  @spec a11y(markdown :: t(), a11y :: Toddy.Type.A11y.t()) :: t()
  def a11y(%__MODULE__{} = md, a11y), do: %{md | a11y: A11y.cast(a11y)}

  @doc "Converts this markdown struct to a `ui_node()` map via the `Toddy.Widget` protocol."
  @spec build(markdown :: t()) :: Toddy.Widget.ui_node()
  def build(%__MODULE__{} = md), do: Toddy.Widget.to_node(md)
