defmodule Toddy.Widget.Scrollable do
  @moduledoc """
  Scrollable container -- wraps child content in a scrollable viewport.

  ## Props

  - `width` (length) -- width of the scrollable area. Default: shrink. See `Toddy.Type.Length`.
  ...
  - `direction` (atom) -- scroll direction: `:vertical` (default), `:horizontal`, or `:both`.
    See `Toddy.Type.Direction`. Setting `:both` enables bidirectional scrolling,
  ...
  @type option ::
          ...
          | {:direction, Toddy.Type.Direction.t()}
          | {:spacing, number()}
          | {:scrollbar_width, number()}
          | {:scrollbar_margin, number()}
          | {:scroller_width, number()}
          | {:anchor, Toddy.Type.Anchor.t()}
          | {:on_scroll, boolean()}
          | {:auto_scroll, boolean()}
          | {:scrollbar_color, Toddy.Type.Color.input()}
          | {:scroller_color, Toddy.Type.Color.input()}
  ...
  @type t :: %__MODULE__{
          ...
          direction: Toddy.Type.Direction.t() | nil,
          spacing: number() | nil,
          scrollbar_width: number() | nil,
          scrollbar_margin: number() | nil,
          scroller_width: number() | nil,
          anchor: Toddy.Type.Anchor.t() | nil,
          on_scroll: boolean() | nil,
          auto_scroll: boolean() | nil,
          scrollbar_color: Toddy.Type.Color.t() | nil,
          scroller_color: Toddy.Type.Color.t() | nil,
  ...
  @spec width(scrollable :: t(), width :: Toddy.Type.Length.t()) :: t()
  def width(%__MODULE__{} = s, width), do: %{s | width: width}

  @doc "Sets the scrollable height."
  @spec height(scrollable :: t(), height :: Toddy.Type.Length.t()) :: t()
  def height(%__MODULE__{} = s, height), do: %{s | height: height}

  @doc "Sets the scroll direction."
  @spec direction(scrollable :: t(), direction :: Toddy.Type.Direction.t()) :: t()
  ...
  @spec anchor(scrollable :: t(), anchor :: Toddy.Type.Anchor.t()) :: t()
  ...
  @spec scrollbar_color(scrollable :: t(), scrollbar_color :: Toddy.Type.Color.input()) :: t()
  ...
  @spec scroller_color(scrollable :: t(), scroller_color :: Toddy.Type.Color.input()) :: t()
  ...
  @spec push(scrollable :: t(), child :: Toddy.Widget.ui_node() | struct()) :: t()
  def push(%__MODULE__{} = s, child), do: %{s | children: [child | s.children]}

  @doc "Appends multiple children to the scrollable."
  @spec extend(scrollable :: t(), children :: [Toddy.Widget.ui_node() | struct()]) :: t()
  def extend(%__MODULE__{} = s, children),
    do: %{s | children: Enum.reverse(children) ++ s.children}

  @doc "Sets accessibility annotations."
  @spec a11y(scrollable :: t(), a11y :: Toddy.Type.A11y.t()) :: t()
  def a11y(%__MODULE__{} = s, a11y), do: %{s | a11y: A11y.cast(a11y)}

  @doc "Converts this scrollable struct to a `ui_node()` map via the `Toddy.Widget` protocol."
  @spec build(scrollable :: t()) :: Toddy.Widget.ui_node()
  def build(%__MODULE__{} = s), do: Toddy.Widget.to_node(s)
