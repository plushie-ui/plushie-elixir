defprotocol Toddy.Widget do
  @moduledoc """
  Protocol for converting typed widget structs to `ui_node()` maps.

  Each widget module under `Toddy.Widget.*` defines a struct with
  ...
  @doc "Converts a widget struct to a `Toddy.Widget.ui_node()` map."
