defmodule Toddy.Type.A11y do
  ...
  ## Examples
      ...
      iex> Toddy.Type.A11y.cast(%{role: :heading, level: 1})
      %Toddy.Type.A11y{role: :heading, level: 1}

      iex> a11y = %Toddy.Type.A11y{label: "Close"}
      iex> Toddy.Type.A11y.cast(a11y)
      %Toddy.Type.A11y{label: "Close"}
  """
