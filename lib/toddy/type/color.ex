defmodule Toddy.Type.Color do
  ...
  ## Examples
      ...
      iex> Toddy.Type.Color.from_rgb(255, 128, 0)
      "#ff8000"

      iex> Toddy.Type.Color.from_hex("ff8800")
      "#ff8800"
  ...
  ## Examples
      ...
      iex> Toddy.Type.Color.from_rgb(0, 0, 0)
      "#000000"

      iex> Toddy.Type.Color.from_rgb(255, 255, 255)
      "#ffffff"
  ...
  ## Examples
      ...
      iex> Toddy.Type.Color.from_rgba(255, 0, 0, 1.0)
      "#ff0000ff"

      iex> Toddy.Type.Color.from_rgba(0, 0, 0, 0.0)
      "#00000000"

      iex> Toddy.Type.Color.from_rgba(255, 128, 0, 0.5)
      "#ff800080"
  """
  ...
  ## Examples
      ...
      iex> Toddy.Type.Color.from_hex("#ff880080")
      "#ff880080"
  """
  ...
  ## Examples
      ...
      iex> Toddy.Type.Color.cast(:black)
      "#000000"

      iex> Toddy.Type.Color.cast(:transparent)
      "#00000000"

      iex> Toddy.Type.Color.cast("#FF0000")
      "#ff0000"
  ...
  ## Examples
      ...
      iex> Toddy.Type.Color.encode("#ff0000")
      "#ff0000"
  """
