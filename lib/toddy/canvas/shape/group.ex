defmodule Toddy.Canvas.Shape.Group do
...
defimpl Toddy.Encode, for: Toddy.Canvas.Shape.Group do
  def encode(group) do
    %{type: "group", children: Enum.map(group.children, &Toddy.Encode.encode/1)}
    |> put_if(:x, group.x)
    |> put_if(:y, group.y)
