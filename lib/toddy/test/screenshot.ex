defmodule Toddy.Test.Screenshot do
  @moduledoc """
  ...
  `TODDY_UPDATE_SCREENSHOTS=1` to force-update golden files.
  ...
  def assert_match(%__MODULE__{} = screenshot, golden_dir) do
    ...
    cond do
      System.get_env("TODDY_UPDATE_SCREENSHOTS") == "1" ->
      ...
      true ->
        ...
        if expected == screenshot.hash do
          ...
          raise ExUnit.AssertionError,
            ...
            Run with TODDY_UPDATE_SCREENSHOTS=1 to update the golden file.
