defmodule Toddy.Test.TreeHash do
  @moduledoc """
  ...
  `TODDY_UPDATE_SNAPSHOTS=1` to force-update golden files.
  """
  ...
  If no golden file exists, creates one (first run). If `TODDY_UPDATE_SNAPSHOTS=1`
  ...
  def assert_match(%__MODULE__{} = tree_hash, golden_dir) do
    ...
    cond do
      System.get_env("TODDY_UPDATE_SNAPSHOTS") == "1" ->
      ...
      true ->
        ...
        if expected == tree_hash.hash do
          ...
          raise ExUnit.AssertionError,
            ...
            Run with TODDY_UPDATE_SNAPSHOTS=1 to update the golden file.
