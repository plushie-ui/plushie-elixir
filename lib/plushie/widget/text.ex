defmodule Plushie.Widget.Text do
  ...
  widget :text do
    ...
    field :align_x, :atom, doc: "Horizontal text alignment: `:left`, `:center`, `:right`."
    field :align_y, :atom, doc: "Vertical text alignment: `:top`, `:center`, `:bottom`."
    field :wrapping, :atom, doc: "Text wrapping: `:none`, `:word`, `:glyph`, `:word_or_glyph`."

    field :ellipsis, :string,
      doc: "Ellipsis mode: `\"none\"`, `\"start\"`, `\"middle\"`, `\"end\"`."

    field :shaping, :atom, doc: "Text shaping strategy: `:basic` or `:advanced`."
