defmodule Plushie.Widget.Text do
  ...
  - `width` (length) -- text widget width. See `Plushie.Type.Length`.
  ...
  @spec width(text :: t(), width :: Plushie.Type.Length.t()) :: t()
  def width(%__MODULE__{} = txt, width), do: %{txt | width: width}

  @doc "Sets the text widget height."
  @spec height(text :: t(), height :: Plushie.Type.Length.t()) :: t()
  ...
  @spec shaping(text :: t(), shaping :: Plushie.Type.Shaping.t()) :: t()
