defmodule Plushie.Widget.Slider do
  ...
  - `width` (length) -- slider width. Default: fill. See `Plushie.Type.Length`.
  ...
  @valid_option_keys ~w(step shift_step default width height circular_handle rail_color rail_width style label event_rate a11y)a
  ...
  @spec width(slider :: t(), width :: Plushie.Type.Length.t()) :: t()
  ...
  @spec rail_color(slider :: t(), rail_color :: Plushie.Type.Color.input()) :: t()
  ...
  events per second).
  """
  @spec event_rate(slider :: t(), rate :: non_neg_integer()) :: t()
