defmodule Plushie.Test.Backend.Windowed do
  @moduledoc """
  Windowed test backend with real iced windows.

  Spawns `plushie` which runs a real `iced::daemon` with GPU
  ...
  use Plushie.Test.Backend.RendererBase, call_timeout: 15_000
