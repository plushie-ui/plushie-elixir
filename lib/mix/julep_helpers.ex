defmodule Mix.JulepHelpers do
  ...
  @doc "Returns the path to the julep-renderer source checkout."
  ...
  def renderer_source_path do
    System.get_env("JULEP_RENDERER_SOURCE") ||
      ...
      Path.expand("../julep-renderer")
  end

  @doc "Returns the expected path to the built julep-renderer binary."
  ...
  def renderer_binary_path(release?) do
    ...
    Path.join([renderer_source_path(), "target", profile, "julep-renderer"])
  end
end
